...
Servo servohori; //horizontal servo(BOTTOM part)
int servoh = 0; //assign servo at 0 degree// reset 
int servohLimitHigh = 180; //maximum range of servo is 180 degree  it can be changeable 
int servohLimitLow = 10;   //minimum range of servo is 10 degree is it is also variable 
